...
<body>
    ...
    <strong><h3 style="margin-bottom: 25px; text-align: center; font-size: 30px; margin-left:auto;margin-right:auto; padding:20px; color:white; background-color:#006707 ;"><strong> Details about the Pixel </strong></h3></strong>
    ...
    <div class="col-md-" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        $pic_id = $_GET["id"];
        $sql1 = "SELECT * FROM  photos p, photographers pg WHERE p.pic_id = '$pic_id' AND p.pic_id=p.pic_id AND p.photographer_username = pg.photographer_username";
        ...
        <div class="container" style="padding:30px; background-color:#F5F5F5;text-align:justify;">    
         <center><img class="card-img-detail lesszoom responsive" src="<?php echo $pic_img; ?>" alt="Card image cap"></center>
          ...
          <!-- <div class="form-group"> -->
            ...
            <hr>
            <h4> <strong>Photographer Name:</strong>  <?php echo $photographer_name; ?></h4><br>
            <h4> <strong>Phone: </strong> <?php echo $photographer_phone; ?></h4><br>
            <h4> <strong>Email: </strong> <?php echo $photographer_email; ?></h4>
            <hr>
            
            <a href="viewphotographer.php?id=<?php echo($photographer_username) ?>" style="color:white; background-color:Green;padding:5px;">Click for more from - <?php echo $photographer_name; ?></a>
            </div>
          </form>
      </div>
    </div>
