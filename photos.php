...
<body>
    ...
    <strong><h3 style="margin-bottom: 25px; text-align: center; font-size: 30px; margin-left:auto;margin-right:auto; padding:20px; color:white; background-color:#006707 ;"> <strong>Your Contibution in Pixels</strong></h3></strong>
    <br>
    ...
    <section class="menu-content">
            ...
            $sql1 = "SELECT * FROM photos p WHERE p.pic_id=p.pic_id AND p.photographer_username='$user' ";
            ...
            if(mysqli_num_rows($result1) > 0) {
                while($row1 = mysqli_fetch_assoc($result1)){
                    ...
                    ?>
            <a href="photodetails.php?id=<?php echo($pic_id) ?>">
