...
<body>
    ...
    <strong><h3 style="margin-bottom: 25px; text-align: center; font-size: 30px; margin-left:auto;margin-right:auto; padding:20px; color:white; background-color:#001560;"> <strong>Get started by creating your account </strong></h3></strong>
    
    <div class="login-clean">
        <form role="form" action="photographer_registered_success.php" method="POST">
            <h2 class="sr-only">Login Form</h2>
            <div class="illustration"><i class="icon ion-ios-navigate"></i></div>
            <div class="form-group"><input class="form-control" type="text" id="photographer_username"  name="photographer_username" placeholder="Your Username" required="" autofocus=""></div>
            ...
            <div class="form-group"><input class="form-control" type="text" id="photographer_name"  name="photographer_name" placeholder="Your Full Name" required="" autofocus=""></div>
            <div class="form-group"><input class="form-control" type="email" id="photographer_email"  name="photographer_email" placeholder="Your Email" required="" autofocus=""></div>
            <div class="form-group"><input class="form-control" type="text" id="photographer_phone"  name="photographer_phone" placeholder="Your Phone" required="" autofocus=""></div>
            <div class="form-group"><input class="form-control" type="text" id="photographer_address"  name="photographer_address" placeholder="Your Address" required="" autofocus=""></div>
            <div class="form-group">
                <button class="btn btn-primary btn-block" name="submit" type="submit">Register</button>
            </div><a class="forget" href="photographerlogin.php">Have an account? Login.</a>
